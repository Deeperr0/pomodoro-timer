...
export default function Navbar({ backgroundColor, font, user }) {
  ...
  return (
    <>
      <nav className="relative grid grid-cols-3 w-full pt-8 md:pt-20 lg:pt-12">
        {/* {toggleLogin && (
          <Login setToggleLogin={setToggleLogin} fontFamily={font} />
        )}
        {toggleRegister && (
          <Register
            user={user}
        ...
        {/* {user == null ? (
          <div className="relative flex justify-self-end pr-20">
            <button
              className="px-10 hover:bg-white hover:bg-opacity-20 rounded-full translate-x-7 z-1"
              onClick={() => setToggleLogin(true)}
            >
              Login
            </button>
            <button
              className="px-7 py-2 rounded-full z-10 transition-all duration-300 hover:!bg-opacity-20 text-veryDarkBlue"
          ...
          <div>
            ...
            <div
              className="aspect-square rounded-full w-14 h-14 bg-black text-white text-3xl justify-self-end mr-20 flex justify-center items-center font-semibold"
